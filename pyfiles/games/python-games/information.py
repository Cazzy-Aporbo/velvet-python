...
class MultiscaleInformationVisualizer:
    ...
    def _render_scale_transitions(self):
        ...
        # Scale indicators
        for i, (scale, name) in enumerate(zip(scales, scale_names, strict=False)):
            # Scale node
    ...
    def _render_dimensional_portals(self):
        ...
        if portal_activities:
            ...
            for i, (bar, portal) in enumerate(zip(bars, self.dimensional_portals, strict=False)):
    ...
    def _render_processing_capacity(self):
        ...
        # Add scale labels
        for angle, scale, value in zip(angles[:-1], scales, normalized_values[:-1], strict=False):
    ...
    def _render_information_cascade(self):
        ...
        if self.information_cascade_data:
            ...
            for scale, color in zip(scales_to_plot, colors_to_plot, strict=False):
