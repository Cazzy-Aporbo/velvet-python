...
class VesselType(Enum):
    ...
    @property
    def valve_spacing(self) -> float | None:
...
class ImmuneCell:
    ...
    antigen_specificity: str | None = None
...
class LymphaticNetwork:
    ...
    def _find_nearest_lymph_node(self, position: Position) -> str | None:
    ...
    def _solve_pressure_field(self) -> dict[str, float]:
        ...
        try:
            ...
            return dict.fromkeys(self.graph.nodes(), self.tissue_pressure)
    ...
    def visualize_network(self, flow_rates: dict[str, float] | None = None) -> None:
        """
