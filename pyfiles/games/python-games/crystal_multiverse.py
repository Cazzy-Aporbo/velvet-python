...
class MultiverseVisualizer:
    ...
    def _render_particle_spectrum(self):
        ...
        if virtual_particles:
            ...
            for i, (center, height) in enumerate(zip(bin_centers, hist, strict=False)):
    ...
    def _render_dimensional_projection(self):
        ...
        for i, (dim, energy, crystal) in enumerate(zip(crystal_dims, crystal_energies, self.quantum_crystals, strict=False)):
    ...
    def _render_energy_cascade(self):
        ...
        # Add energy sparks
        for i, (level, value) in enumerate(zip(energy_levels, cascade_values, strict=False)):
